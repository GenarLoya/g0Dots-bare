...
-- See https://wiki.hypr.land/Configuring/Advanced-and-Cool/Permissions/
 cursor = { -- https://wiki.hypr.land/Configuring/Basics/Variables/#cursor
        ...
        inactive_timeout = 500,                     -- In seconds, after how many seconds of cursor’s inactivity to hide it. Set to 0 for never.
        ...
        enable_hyprcursor = false,                   -- whether to enable hyprcursor support
