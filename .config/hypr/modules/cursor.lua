hl.config({
    cursor = { -- https://wiki.hypr.land/Configuring/Basics/Variables/#cursor
        ...
        no_hardware_cursors = true,                    -- disables hardware cursors. 0 - use hw cursors if possible, 1 - don’t use hw cursors, 2 - auto (disable when tearing)
        ...
        hide_on_touch = false,                      -- nunca esconder en touch
        hide_on_tablet = false,                     -- nunca esconder en tablet
